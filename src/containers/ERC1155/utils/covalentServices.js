...
const tokenUriDoE = 'https://ipfs.io/ipfs/QmcxJeVYRhyevvwQgsBfSWiY7QVmyNx1rQinzXbc1ZYut5/'
const tokenImageUriDoE = 'https://ipfs.io/ipfs/QmdKKy9vrLvkXtYZwAiaKSWgtuHXk3HuSDoQ1m5GTWc5H2/'
...
covalentServices.fetchTokenVault = async (address) => {
  const url = `${covalentUri + address}/balances_v2/?nft=true&no-nft-fetch=true&key=ckey_2f68f1fc3e374e3a8a1a5a129e9`;
